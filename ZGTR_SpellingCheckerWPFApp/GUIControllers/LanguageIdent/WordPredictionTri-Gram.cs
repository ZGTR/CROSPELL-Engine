...
{
   public class WordPredictionTri_Gram
    {
       private MainWindow MainWindow;
        public WordPredictionTri_Gram(MainWindow mainWindow)
        {
        ...
        private Dictionary<string, int> FindingPredictedWords(string[] textWords)
        {
            ...
            {
                Predictedwords = language.LanguagetriGramWordPrediction(textWords);
            }
        ...
        void InitializeWords()
        {
            ...
            string[] txtFiles = Directory.GetFiles("Common words\\triGram", "*.txt");
            foreach (Language language in _languages)
            {
                foreach (string txtFileName in txtFiles)
                {
                    ...
                    {
                        language.IntializetriGramWords(txtFileName, false);
                        break;
                    }
                }
            }
